...
func TestInsertBuild(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			wants: []buildResult{
				{query: "INSERT INTO t (c1,c2) VALUES ($1,$2)", args: []any{1, 2}},
				{query: "INSERT INTO t (c2,c1) VALUES ($1,$2)", args: []any{2, 1}},
			},
		},
		{
			name: "values",
		...
		},
		{
			...
			wants: []buildResult{
				{query: "INSERT INTO t (c) VALUES ($1) RETURNING c1,c2,c3,c4", args: []any{1}},
			},
		},
	}
